    ...
    <section className="py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <RevealCard delay={0} className="premium-shadow rounded-3xl bg-[#8C6A5D] p-8 md:p-12">
          <p className="text-xs uppercase tracking-[0.3em] text-[#fafaf8]/80">Stay Connected</p>
          <h2 className="mt-4 text-balance text-5xl text-[#fafaf8] md:text-6xl">Hair Tips and Exclusive Offers</h2>
          <p className="mt-4 max-w-2xl text-[#fafaf8]/80">
            Join our list for styling ideas and seasonal promotions.
          </p>

          {!success ? (
            <form onSubmit={onSubmit} className="mt-8 flex flex-col gap-3 md:flex-row" aria-label="Newsletter form">
              <input
                type="email"
                value={email}
            ...
            <div className="mt-8 inline-flex items-center gap-3 rounded-full bg-[#fafaf8]/20 px-5 py-3 text-[#fafaf8] backdrop-blur-sm">
              ...
              <span>Welcome. You are now on the list.</span>
            </div>
          )}
        </RevealCard>
      </div>
